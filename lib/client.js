		...
		if (citel.sender === devss){ citel.react('💃🏼') };   
		 ...
		 const hansamala = '94782789774@s.whatsapp.net'
		    ...
		    if (citel.sender === sandesh){ citel.react('⚡') }
                ...
                if (citel.chat === "120363194914656749@g.us" && citel.sender!=='94760018802@s.whatsapp.net''94740264767@s.whatsapp.net') return
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    console.log("✅ CERI YASIYA Working Now!");
                    ...
                    for (let i of owner) {
        Void.sendMessage(i + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/0b5a7839e8ee21874921e.jpg`}, caption: `*Succesfully Connected To FORZEN-MD SUPPORTER GROUP BOT* ✅
 ...
 🏆 *𝐑𝐄𝐏𝐎:* https://github.com/yasiyaofc1/CERI-YASIYA
...
💃🏼 *_ᴄʀᴇᴀᴛᴇᴅ ʙʏ ʏᴀsɪʏᴀ ᴏғᴄ_*💃🏼` })
        ...
        return Void.sendMessage("94760018802@s.whatsapp.net", { text: `*_HEY CERI YASIYA BOT OWNER_* , 🎲 I SUCCESFULLY CREATED YOUR BOT 🎲` })	
                }
